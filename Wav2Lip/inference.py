...
parser.add_argument('--crop', nargs='+', type=int, default=[0, -1, 0, -1],
                    help='Crop video to a smaller region (top, bottom, left, right). Applied after resize_factor and rotate arg. ' 
                         'Useful if multiple faces present. -1 implies the value will be auto-inferred based on height, width')
...
def main(args):
    ...
    subprocess.check_call([
        ...
        "-preset", "veryslow", # Maximum compression efficiency / quality
        "-crf", "10",          # Near lossless (0 is lossless, 10 is extremely high quality)
        "-c:a", "aac",         # AAC audio
        "-b:a", "320k",        # Maximum AAC audio bitrate
...
def do_load(checkpoint_path):
    ...
    if torch.cuda.is_available():
        ...
        detector = RetinaFace(model_path="/Users/uday/Downloads/VIDEOYT/checkpoints/mobilenet.pth", network="mobilenet")
