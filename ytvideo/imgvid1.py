...
def generate_image_for_sentence(topic: str, sentence: str, image_index: int = 0) -> str:
    prompt = (
        "Generate a high-resolution horizontal image (1920x1080) that visually represents the following concept "
...
def create_video_from_script_with_whisperx(script, user_topic):
    ...
    try:
        ...
        bg_music_looped = bg_music_raw.fx(vfx.loop, duration=final_video.duration).set_start(0)
